...
//     wp_register_style('html5blank3', get_template_directory_uri() . '/theme.css', array(), '1.0', 'all');
    wp_register_style('html5blank4', get_template_directory_uri() . '/natuive-wordpress.min.css', array(), filemtime( get_stylesheet_directory() . '/natuive-wordpress.min.css' ), 'all');
